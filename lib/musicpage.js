    ...
    HTML: function (musics, Music_info_list) {
        ...
        <html lang="en" dir="ltr">
                ...
                <div class="maincontainer">
                    ...
                    <div id="Music-player">
                        <div id="Main-panel">
                            ...
                            <div id="lyrics-zone">
                                <div id = "lyrics-zone_header">
                                    <div id="lyrics-zone_musicname"></div>
                                    <div id="lyrics-zone_artistname"></div>
                                </div>
                                <div id = "lyrics-zone_body">
            ...
            <script>
                ...
                var lyrics_zone_musicname = document.getElementById("lyrics-zone_musicname");
                var lyrics_zone_artistname = document.getElementById("lyrics-zone_artistname");
                ...
                function onPlayvideo(video_num){
                    ...
                    lyrics_zone_musicname = videos[video_num].musictitle;
                    lyrics_zone_artistname = videos[video_num].artist;
                ...
                function onPlayerReady(event) {
                    ...
                    lyrics_zone_musicname = videos[index].musictitle;
                    lyrics_zone_artistname = videos[index].artist;
                ...
                function onPlayerStateChange(event) {
                    if (event.data === YT.PlayerState.ENDED) {
                        ...
                        lyrics_zone_musicname = videos[video_code_number + 1].musictitle;
                        lyrics_zone_artistname = videos[video_code_number + 1].artist;
