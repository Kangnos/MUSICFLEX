    ...
    <html lang="en" dir="ltr">
        ...
        <script>
            ...
            function BackMusic() {
                console.log(index)
                console.log(count)
                console.log(videos[0].artist - " - " - videos[0].musictitle)
                if(index === 0){
                    ...
                    MusicName.innerHTML = videos[index - 1-count].artist - " - " - videos[index - 1 - count].musictitle;
                    Pagetitle.innerHTML = videos[index - 1-count].musictitle;
                }
            }
