module.exports = {
    ...
    <html lang="en" dir="ltr">
        ...
        <script>
            ...
            // Buttons functions
            function BackMusic() {
                for (let i = 1; i < listvideos.length; i++) {
                    j = i % 10
                    player.loadVideoById(listvideos[index-1 - j])
                    MusicName.innerHTML = videos[index - 1 - j].artist + " - " + videos[index - 1 - j].musictitle;
                    Pagetitle.innerHTML = videos[index - 1 - j].musictitle;
                }
            }
