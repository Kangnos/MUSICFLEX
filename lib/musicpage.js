    ...
    HTML: function (musics, Music_info_list) {
        ...
        <html lang="en" dir="ltr">
            ...
            <body>
                <div class="maincontainer">
                    ...
                    <div id="Music-player">
                        ...
                        <div id="Type-panel">
                            <div id="Types">
                                <div class="Type"><a href="../Rap" class="type-a" rel="no-refresh"><span>▶</span> Hiphop</a></div>
            ...
            <script>
                ...
                function onPlayvideo(video_code_number){
                    var video = listvideos[video_code_number];
                    player.loadVideoById(video)
                    console.log(video)
                    console.log(video_code_number)
                    MusicName.innerHTML = videos[video_code_number].artist + " - " + videos[video_code_number].musictitle;
                    Pagetitle.innerHTML = videos[video_code_number].musictitle;
                    video_code_number = video_code_number
                    console.log(video_code_number)
                }
